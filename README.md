...
本项目由 [**Andy**](https://github.com/ankunhou) [**(ankunhou)**](https://github.com/ankunhou) 以 [MIT License（英文原文及简体中文参考译文）](LICENSE) 开源。英文原文为授权依据，中文译文用于辅助理解。MIT 许可证覆盖本仓库中的代码和项目文档，不自动授予任何输入剧本、模型输出、第三方商标或其他外部材料的权利。
